...
class Graph
{
    unordered_map<char, const unordered_map<char, int>> vertex;
private:
        unordered_map<char, const unordered_map<char, int>> vertices; //Mapa con la siguiente estructura:
                            //{'char0',{{'char1',costo1},....,{charn-1,costo n-1}}}
public:
...
int main()
{
    ...
    Graph g;
    g.add_vertex('0', {{'1', 4}, {'3', 5}, {'2', 3}});
    g.add_vertex('1', {{'4', 1}});
    g.add_vertex('2', {{'1', 1}, {'3', 2},{'4',1}});
    g.add_vertex('3', {{4,1}});
    g.add_vertex('4', {});
